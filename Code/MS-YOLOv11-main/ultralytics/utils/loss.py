...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], # When using the SDIoU loss function, let d=0.3, 0.5, 0.7 be OK
                       xywh=False, GIoU=False, DIoU=False, CIoU=True, EIoU=False, SIoU=False,SDIoU=False,d=0.3,
                       WIoU=False, ShapeIoU=False, Inner=False,  mpdiou=False,  ratio=0.75, eps=1e-7, scale=0.0)
...
# class BboxLoss(nn.Module): #Original
#     """Criterion class for computing training losses during training."""
#
...
# class v8DetectionLoss: #Original
#     """Criterion class for computing training losses."""
#
